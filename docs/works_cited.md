I created Imogen (and learned how to code while doing it) by gathering a wealth of resources: tutorials, examples, articles, and research papers. Some specific items warrant explicit recognition:
